...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  return (
    <div className={`fixed inset-0 z-50 flex items-center justify-center ${isElectron() ? 'p-1' : 'p-3'} bg-black/50 backdrop-blur-xs animate-in fade-in duration-200`}>
      <div
        className={`w-full max-w-lg max-h-[95vh] flex flex-col rounded-[28px] overflow-hidden ${isElectron() ? 'shadow-none' : 'shadow-2xl'} border transition-all apple-liquid-glass backdrop-blur-3xl ${
          isDark
      ...
      >
        {/* Modal Header */}
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-black/5 dark:border-white/10 shrink-0 app-region-drag select-none">
